...
//             .channel(`leaderboard-quiz-${quizId}`)
//             .on(
//                 'postgres_changes',
//                 {
//                     event: '*',
...
//         const channel = supabase
//             .channel(`leaderboard-players-${quizId}`)
//             .on(
//                 'postgres_changes',
//                 {
//                     event: '*',
...
//                     setPlayers(prev => {
//                         const copy = [...(prev ?? [])];
//                         const idx = copy.findIndex(p => p.id === updated.player_id);

//                         const mapped = {
//                             id: updated.player_id,
//                             name: updated.player_name,
//                             score: updated.score,
//                             avatar: updated.avatar ?? '/default-avatar.png',
//                             clan: updated.clan ?? null,
//                             answers: prev?.[idx]?.answers ?? [],
//                         };

//                         if (idx >= 0) copy[idx] = mapped;
//                         else copy.push(mapped);
...
//         // });
//         await supabase.from('quiz_reactions').insert({
//             quiz_id: quizId,
//             player_id: playerId,
//             emoji,
...
const LeaderboardPage: React.FC = () => {
    ...
    const playerId = useMemo(
        () => (quizId ? localStorage.getItem(`quiz-player-${quizId}`) : null),
        [quizId]
    );
